...
# Smaller figure to fit without scrolling
...
bars_2010 = ax1.bar([i - bar_width/2 for i in x], games_2010, width=bar_width, 
                    label='2010 Games', alpha=0.6, color='#9e9ac8')
bars_2021 = ax1.bar([i + bar_width/2 for i in x], games_2021, width=bar_width, 
                    label='2021 Games', alpha=0.6, color='#fdae6b')

ax1.set_xlabel('Stadium', fontsize=9)
ax1.set_ylabel('Number of Games', fontsize=9, color='#333')
ax1.set_xticks(x)
ax1.set_xticklabels(stadiums, rotation=30, ha='right', fontsize=7)
...
line_2010, = ax2.plot(x, avg_runs_2010, label='2010 Avg Runs/Game', 
                      color='#6a51a3', marker='o', linewidth=1.5, markersize=4)
line_2021, = ax2.plot(x, avg_runs_2021, label='2021 Avg Runs/Game', 
                      color='#e6550d', marker='o', linewidth=1.5, markersize=4)

ax2.set_ylabel('Avg Runs/Game', fontsize=9, color='#333')
ax2.tick_params(axis='y', labelcolor='#333', labelsize=8)

# Title and legend
fig.suptitle('Games per Stadium & Avg Runs/Game (2010 vs 2021)', fontsize=11, fontweight='bold')
...
plt.tight_layout(rect=[0, 0, 1, 0.9], pad=0.8)
plt.show()
...
axes[0].set_title("Average Runs per Game (2010 Season)", fontsize=12, fontweight='bold')
...
axes[0].annotate(f"COL: {col_value_2010:.2f}",
                 ...
                 xytext=(col_value_2010 + 0.1, col_index_2010 + 0.5),
                 arrowprops=dict(arrowstyle='->', color='darkorchid', lw=2),
                 fontsize=8, fontweight='bold', color='darkorchid',
                 bbox=dict(facecolor='white', alpha=0.7, edgecolor='none'))

# --- Right subplot: 2021 ---
axes[1].barh(comparison_data.home, comparison_data.runs_2021, color=colorado_colors_2021)
axes[1].set_title("Average Runs per Game (2021 Season)", fontsize=12, fontweight='bold')
axes[1].set_xlabel("Average Runs per Game", fontsize=10)
...
axes[1].annotate(f"COL: {col_value_2021:.2f}",
                 ...
                 xytext=(col_value_2021 + 0.1, col_index_2021 + 0.5),
                 arrowprops=dict(arrowstyle='->', color='darkorchid', lw=2),
                 fontsize=8, fontweight='bold', color='darkorchid',
                 bbox=dict(facecolor='white', alpha=0.7, edgecolor='none'))
...
# Add legend *below* the plots (so it doesn’t overlap)
...
fig.legend(handles=[colorado_patch, other_patch],
